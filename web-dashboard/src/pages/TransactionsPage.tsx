...
export function TransactionsPage() {
  ...
  const filteredTransactions = mockTransactions
    .filter((txn) => {
      const matchesSearch =
        txn.id.toLowerCase().includes(debouncedSearch.toLowerCase()) ||
        txn.userId.toLowerCase().includes(debouncedSearch.toLowerCase()) ||
        txn.location.toLowerCase().includes(debouncedSearch.toLowerCase());
    ...
    .sort((a, b) => {
      ...
      if (sortBy === 'fraudScore') return (a.fraudScore - b.fraudScore) * multiplier;
                ...
                <TableBody>
                  {filteredTransactions.map((txn, index) => (
                    ...
                    >
                      ...
                      <TableCell className="text-muted-foreground">{txn.userId}</TableCell>
